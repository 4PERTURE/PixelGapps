...
installer_name="PixelGapps Slim 10.0 - ";
...
product/overlay/framework-res__auto_generated_rro_product"
...
ui_print '              .,-:;//;:=,               ';
ui_print '          . :H@@@MM@M#H/.,+%;,          ';
ui_print '       ,/X+ +M@@M@MM%=,-%HMMM@X/,       ';
ui_print '     -+@MM; $M@@MH+-,;XMMMM@MMMM@+-     ';
ui_print '    ;@M@@M- XM@X;. -+XXXXXHHH@M@M#@/.   ';
ui_print '  ,%MM@@MH ,@%=             .---=-=:=,. ';
ui_print '  =@#@@@MX.,                -%HX$$%%%:; ';
ui_print ' =-./@M@M$                   .;@MMMM@MM:';
ui_print ' =-./@M@M$                   .;@MMMM@MM:';
ui_print ' X@/ -$MM/                    . +MM@@@M$';
ui_print ',@M@H: :@:                    . =X#@@@@-';
ui_print ',@@@MMX, .                    /H- ;@M@M=';
ui_print '.H@@@@M@+,                    %MM+..%#$.';
ui_print ' /MMMM@MMH/.                  XM@MH; =; ';
ui_print '  /%+%$XHH@$=              , .H@@@@MX,  ';
ui_print '   .=--------.           -%H.,@@@@@MX,  ';
ui_print '   .%MM@@@HHHXX$$$%+- .:$MMX =M@@MM%.   ';
ui_print '     =XMMM@MM@MM#H;,-+HMM@M+ /MMMX=     ';
ui_print '       =%@M@M#@$-.=$@MM@@@M; %M%=        ';
ui_print '         ,:+$+-,/H#MMMMMMM@= =,         ';
ui_print '               =++%%%%+/:-.             ';
ui_print '                                        ';
